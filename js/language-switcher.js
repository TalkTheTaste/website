(function () {
  ...
  const dictionary = {
    ...
    'Social media management starts at AED 4,000 per month, SEO starts at AED 1,500 per month, onsite shoots start at AED 450, ecommerce websites start at AED 5,000, and the basic 5-page website starts at AED 2,000.': 'تبدأ إدارة وسائل التواصل من 4,000 درهم شهريا، ويبدأ SEO من 1,500 درهم شهريا، وتبدأ جلسات التصوير من 450 درهما، وتبدأ المتاجر الإلكترونية من 5,000 درهم، ويبدأ الموقع الأساسي من 5 صفحات من 2,000 درهم.',
    'Websites': 'المواقع',
    ...
    'How much does a basic 5-page website cost?': 'كم تبلغ تكلفة الموقع الأساسي من 5 صفحات؟',
    ...
    'Premium 5-page websites from AED 2,000 and landing pages built for trust, speed and conversion.': 'مواقع احترافية من 5 صفحات تبدأ من 2,000 درهم، وصفحات هبوط مبنية للثقة والسرعة والتحويل.',
    ...
    'social media marketing Dubai': 'تسويق وسائل التواصل في دبي',
    'The basic 5-page website starts at AED 2,000. Larger booking, ecommerce and custom website development scopes are quoted after discovery. See': 'يبدأ الموقع الأساسي من 5 صفحات من 2,000 درهم. المواقع الأكبر للحجز أو التجارة الإلكترونية أو التطوير المخصص تسعر بعد الاكتشاف. شاهد',
    'web design Dubai': 'تصميم المواقع في دبي',
    ...
    'What is included in the AED 2,000 website?': 'ماذا تشمل باقة الموقع بسعر 2,000 درهم؟',
    'Can you build restaurant booking websites?': 'هل يمكنكم بناء مواقع حجز للمطاعم؟',
    'Selected Website Work': 'نماذج مختارة من أعمال المواقع',
    'Built for businesses, stores and digital products.': 'مواقع مصممة للأعمال والمتاجر والمنتجات الرقمية.',
    'Business Websites': 'مواقع الأعمال',
    'Ecommerce Websites': 'مواقع التجارة الإلكترونية',
    'Premium Websites': 'مواقع احترافية متقدمة',
    'Portals & Web Applications': 'البوابات وتطبيقات الويب',
    'From AED 2,000': 'تبدأ من 2,000 درهم',
    'From AED 5,000': 'تبدأ من 5,000 درهم',
    'From AED 20,000': 'تبدأ من 20,000 درهم',
    'From AED 25,000': 'تبدأ من 25,000 درهم',
  ...
  function addFloatingWhatsapp() {
    ...
    link.href = 'https://wa.me/971565390316';
    link.target = '_blank';
    link.rel = 'noopener';
    link.setAttribute('aria-label', 'Contact Talk The Taste on WhatsApp');
    link.setAttribute('data-track', 'whatsapp_click');
    link.setAttribute('data-track-label', 'Floating WhatsApp');
    link.innerHTML = '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"></path></svg>';
    document.body.appendChild(link);
  }

  function ensureMobileWhatsapp() {
    const nav = document.getElementById('nav');
    if (!nav || nav.querySelector('.nav-wa-mobile')) return;
    const link = document.createElement('a');
    link.className = 'nav-wa-mobile';
    link.href = 'https://wa.me/971565390316';
    link.target = '_blank';
    link.rel = 'noopener';
    link.setAttribute('aria-label', 'Contact Talk The Taste on WhatsApp');
